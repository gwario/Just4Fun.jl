...
@testset "all_sorted_card_combinations" begin
    ...
    combinations = Just4Fun.all_sorted_card_combinations(
        Cards([CardValue(1), CardValue(2), CardValue(3), CardValue(4), CardValue(5)]),
        0,
    )
    @test combinations == [Cards()]
    ...
    @test issetequal(
        ...
        [
            ...
            Cards([CardValue(1), CardValue(5)]),
            Cards([CardValue(2), CardValue(3)]),
            Cards([CardValue(2), CardValue(4)]),
            Cards([CardValue(2), CardValue(5)]),
            Cards([CardValue(3), CardValue(4)]),
            Cards([CardValue(3), CardValue(5)]),
            Cards([CardValue(4), CardValue(5)]),
        ],
    )
    ...
    @test issetequal(
        ...
        [
            ...
            Cards([CardValue(1), CardValue(2), CardValue(5)]),
            Cards([CardValue(1), CardValue(3), CardValue(4)]),
            Cards([CardValue(1), CardValue(3), CardValue(5)]),
            Cards([CardValue(1), CardValue(4), CardValue(5)]),
            Cards([CardValue(2), CardValue(3), CardValue(4)]),
            Cards([CardValue(2), CardValue(3), CardValue(5)]),
            Cards([CardValue(2), CardValue(4), CardValue(5)]),
            Cards([CardValue(3), CardValue(4), CardValue(5)]),
        ],
    )
    ...
    # all combinations of size up to 1
    combinations = Just4Fun.all_sorted_card_combinations(
        Cards([CardValue(1), CardValue(1), CardValue(2), CardValue(2), CardValue(3)]),
        1,
    )
    @test issetequal(
        combinations,
        [Cards(), Cards([CardValue(1)]), Cards([CardValue(2)]), Cards([CardValue(3)])],
    )
    ...
    @test issetequal(
        ...
        [
            ...
            Cards([CardValue(2)]),
            Cards([CardValue(3)]),
            Cards([CardValue(1), CardValue(1)]),
            Cards([CardValue(2), CardValue(2)]),
            Cards([CardValue(1), CardValue(2)]),
            Cards([CardValue(1), CardValue(3)]),
            Cards([CardValue(2), CardValue(3)]),
        ],
    ...
    @test issetequal(
        ...
        [
            ...
            Cards([CardValue(1), CardValue(3)]),
            Cards([CardValue(2), CardValue(3)]),
            Cards([CardValue(1), CardValue(1), CardValue(2)]),
            Cards([CardValue(1), CardValue(1), CardValue(3)]),
            Cards([CardValue(1), CardValue(2), CardValue(2)]),
            Cards([CardValue(1), CardValue(2), CardValue(3)]),
            Cards([CardValue(2), CardValue(2), CardValue(3)]),
        ],
    )
    ...
    # all combinations of size up to 1
    combinations = Just4Fun.all_sorted_card_combinations(
        Cards([CardValue(1), CardValue(1), CardValue(1), CardValue(2), CardValue(2)]),
        1,
    )
    @test issetequal(combinations, [Cards(), Cards([CardValue(1)]), Cards([CardValue(2)])])
    ...
    @test issetequal(
        ...
        [
            ...
            Cards([CardValue(1), CardValue(2)]),
            Cards([CardValue(2), CardValue(2)]),
            Cards([CardValue(1), CardValue(1), CardValue(1)]),
            Cards([CardValue(1), CardValue(1), CardValue(2)]),
            Cards([CardValue(1), CardValue(2), CardValue(2)]),
        ],
    )
    ...
    @test issetequal(
        ...
        [
            ...
            Cards([CardValue(1), CardValue(1), CardValue(2)]),
            Cards([CardValue(1), CardValue(2), CardValue(2)]),
            Cards([CardValue(1), CardValue(1), CardValue(1), CardValue(2)]),
            Cards([CardValue(1), CardValue(1), CardValue(2), CardValue(2)]),
        ],
    )
end
