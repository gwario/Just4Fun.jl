...
"""
function fields_reachability(spec::Just4FunSpec, all_player_cards::AbstractMatrix{CardValue}, player::Player)::Array{Float32}
...
NOTET: Players are in ascending order from 1
"""
previous_player(spec::Just4FunSpec, player::Player)::Player = next_player(spec, Player(player + spec.settings.players - 0x2))
...
"""
function num_connected_dir(spec::Just4FunSpec, field_stones::AbstractArray{Stones}, player::Player, field_value::FieldValue, dir)::Int64
...
"""
function num_connected_axis(spec::Just4FunSpec, field_stones::AbstractArray{Stones}, player::Player, field_value::FieldValue, axis)::Int64
...
"""
function winning_pattern_at(spec::Just4FunSpec, field_stones::AbstractArray{Stones}, player::Player, field_value::FieldValue)::Bool
